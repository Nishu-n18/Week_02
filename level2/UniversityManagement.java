...
public class UniversityManagement {
    public static void main(String[] args) {
        ...
        Students Nishu = new Students("Nishu");
        Students Nisha = new Students("Nisha");

        Professor drAkshit = new Professor("Dr. Akshit");
        Professor drJones = new Professor("Dr. Jones");

        // Add students and professors to the university
        university.addStudent(Nishu);
        university.addStudent(Nisha);
        university.addProfessor(drAkshit);
        ...
        Nishu.enrollCourse(math);
        Nisha.enrollCourse(physics);

        // Professors assign courses
        drAkshit.assignCourse(math);
